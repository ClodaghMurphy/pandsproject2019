...
print("Using scikit-learn to print the feature names of the dataset")
...
print("Using scikit-learn to print the target data of the dataset, it's numberic and not a string")
print (iris.target)
#
#what the target names are in string format
print("Using scikit-learn to print the target names of the dataset")
